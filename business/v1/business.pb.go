...
const file_api_business_v1_business_proto_rawDesc = "" +
	...
	"\areplyID\x18\x01 \x01(\x03R\areplyID2\x86\x01\n" +
	"\bBusiness\x12z\n" +
	"\vReplyReview\x12#.api.business.v1.ReplyReviewRequest\x1a!.api.business.v1.ReplyReviewReply\"#\x82\xd3\xe4\x93\x02\x1d:\x01*\"\x18business/v1/review/replyB0\n" +
