...
const file_api_review_v1_review_proto_rawDesc = "" +
	...
	"\x04list\x18\x01 \x03(\v2\x19.api.review.v1.ReviewInfoR\x04list2\xab\x06\n" +
	"\x06Review\x12k\n" +
	...
	"\vAuditAppeal\x12!.api.review.v1.AuditAppealRequest\x1a\x1f.api.review.v1.AuditAppealReply\"\x1b\x82\xd3\xe4\x93\x02\x15:\x01*\"\x10/v1/appeal/audit\x12\x83\x01\n" +
	"\x12ListReviewByUserID\x12(.api.review.v1.ListReviewByUserIDRequest\x1a&.api.review.v1.ListReviewByUserIDReply\"\x1b\x82\xd3\xe4\x93\x02\x15\x12\x13v1/{userID}/reviewsB2\n" +
...
var file_api_review_v1_review_proto_goTypes = []any{
	...
	(*ListReviewRequest)(nil),         // 5: api.review.v1.ListReviewRequest
	(*ListReviewReply)(nil),           // 6: api.review.v1.ListReviewReply
...
var file_api_review_v1_review_proto_depIdxs = []int32{
	...
	9,  // 4: api.review.v1.Review.AuditReview:input_type -> api.review.v1.AuditReviewRequest
	7,  // 5: api.review.v1.Review.ReplyReview:input_type -> api.review.v1.ReplyReviewRequest
	11, // 6: api.review.v1.Review.AppealReview:input_type -> api.review.v1.AppealReviewRequest
	13, // 7: api.review.v1.Review.AuditAppeal:input_type -> api.review.v1.AuditAppealRequest
	15, // 8: api.review.v1.Review.ListReviewByUserID:input_type -> api.review.v1.ListReviewByUserIDRequest
	...
	12, // 13: api.review.v1.Review.AppealReview:output_type -> api.review.v1.AppealReviewReply
	14, // 14: api.review.v1.Review.AuditAppeal:output_type -> api.review.v1.AuditAppealReply
	16, // 15: api.review.v1.Review.ListReviewByUserID:output_type -> api.review.v1.ListReviewByUserIDReply
